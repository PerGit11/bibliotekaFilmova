...
export const Header = () => {
    ...
    const activeClass="text-base block py-2 px-2 text-white bg-blue-700 rounded-sm md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500";
    ...
    return (
        <header>
            <nav className="bg-white border-b-2 border-gray-200 dark:bg-gray-950 dark:border-b-1 dark:border-gray-950">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                        <img src={Logo} className="mr-2 h-8 sm:h-9" alt="BibliotekaFilmova Logo"/>
                        <span
                            className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Zbirka Filmova</span>
                    </Link>
                    ...
                    <div id={"mobile-nav"} className="flex md:order-2">
                        ...
                        <div className="relative hidden md:block">
                            ...
                            <input type="text" name={"search"} id="search-navbar"
                                   className="block w-full p-2 ps-10 text-sm text-gray-950 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
